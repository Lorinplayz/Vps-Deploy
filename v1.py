...
║    ╚══════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝╝
║                                                                               ║
║                    Discord VPS Creator Bot - Modified Edition                 ║
║                           Credit: LORINPLAYZ                                  ║
║                      Version: v1.0                                ║
║                                                                               ║
╚═══════════════════════════════════════════════════════════════════════════════╝
...
async def on_ready():
    change_status.start()
    print(f'[LORINPLAYZ] Bot is ready. Logged in as {bot.user}')
    print(f'[LORINPLAYZ] VPS Creator Bot Online!')
    await bot.tree.sync()
...
async def help_command(interaction: discord.Interaction):
    embed = discord.Embed(title="Help - LORINPLAYZ VPS Creator", color=0x00ff00)
    ...
    embed.set_footer(text="Powered by LORINPLAYZ | Original by katy-the-kat")
    await interaction.response.send_message(embed=embed)
